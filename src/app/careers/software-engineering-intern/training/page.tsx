...
export default function SoftwareEngineeringInternTrainingPage() {
  return (
    <div className="text-foreground font-base">
      <main className="relative flex min-h-[60dvh] flex-col overflow-hidden items-center justify-center bg-background px-5 md:py-[140px] py-[100px] bg-[linear-gradient(to_right,#80808033_1px,transparent_1px),linear-gradient(to_bottom,#80808033_1px,transparent_1px)] bg-[size:70px_70px]">
        <div className="mx-auto w-container max-w-full text-center">
          <h1 className="leading-normal mb-6">Software Engineering Intern – Mandatory Learning Based Training</h1>
          <p className="text-xl max-w-4xl mx-auto leading-relaxed">
            Before applying, completion of our Learning Based Training is mandatory. 
            This ensures you have the foundations to build and ship features in our stack.
          </p>
        </div>
      </main>
          ...
          <div className="flex flex-col md:flex-row items-start gap-8 md:gap-12">
            <Card className="rounded-base border-2 border-border bg-background shadow-shadow w-full md:w-[380px]">
              ...
              <CardContent>
                ...
                <Button className="flex items-center gap-2 text-main-foreground rounded-base border-2 border-border bg-main px-6 py-2 shadow-shadow transition-all hover:translate-x-boxShadowX hover:translate-y-boxShadowY hover:shadow-none" asChild>
                  <Link href="/careers/software-engineering-intern/apply">
                    Enroll Now
            ...
            <div className="flex-1">
              ...
              <div className="space-y-6">
                <TimelineItem week="Week 1" title="Web Fundamentals & Git">
                  HTML/CSS/JS refresh, TypeScript basics, Git workflows, PRs and reviews.
                </TimelineItem>
                <TimelineItem week="Week 2" title="React & Next.js Essentials">
                  Components, hooks, state management, routing and data fetching in Next.js.
                </TimelineItem>
                <TimelineItem week="Week 3" title="APIs & Databases">
                  RESTful APIs, authentication basics, PostgreSQL/Prisma or equivalent ORM.
                </TimelineItem>
                <TimelineItem week="Week 4" title="Testing & Quality">
                  Unit/integration testing, linting, type-safety, performance and accessibility.
                </TimelineItem>
                <TimelineItem week="Week 5" title="DevOps Basics">
                  CI/CD pipelines, environment variables, deployments, monitoring and logging.
                </TimelineItem>
                <TimelineItem week="Week 6" title="Capstone Project">
                  Build and ship a feature end-to-end with code reviews and demo.
                </TimelineItem>
              </div>
              ...
              <div className="mt-10">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-start gap-2">
                    <Check className="size-4 text-main mt-0.5 flex-shrink-0" />
                    <span>Eligibility to apply for the Software Engineering internship</span>
                  </li>
                </ul>
              </div>
