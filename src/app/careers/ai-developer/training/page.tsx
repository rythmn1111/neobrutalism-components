...
export default function AIDeveloperTrainingPage() {
  return (
    <div className="text-foreground font-base">
      <main className="relative flex min-h-[60dvh] flex-col overflow-hidden items-center justify-center bg-background px-5 md:py-[140px] py-[100px] bg-[linear-gradient(to_right,#80808033_1px,transparent_1px),linear-gradient(to_bottom,#80808033_1px,transparent_1px)] bg-[size:70px_70px]">
        <div className="mx-auto w-container max-w-full text-center">
          <h1 className="leading-normal mb-6">AI Developer – Mandatory Learning Based Training</h1>
          <p className="text-xl max-w-4xl mx-auto leading-relaxed">
            Before applying for the AI Developer internship, completion of our Learning Based Training is mandatory. 
            This ensures you have the foundational skills to contribute effectively from day one.
          </p>
        </div>
      </main>
          ...
          <div className="flex flex-col md:flex-row items-start gap-8 md:gap-12">
            <Card className="rounded-base border-2 border-border bg-background shadow-shadow w-full md:w-[380px]">
              ...
              <CardContent>
                ...
                <Button className="flex items-center gap-2 text-main-foreground rounded-base border-2 border-border bg-main px-6 py-2 shadow-shadow transition-all hover:translate-x-boxShadowX hover:translate-y-boxShadowY hover:shadow-none" asChild>
                  <Link href="/careers/ai-developer/apply">
                    Enroll Now
            ...
            <div className="flex-1">
              ...
              <div className="space-y-6">
                <TimelineItem week="Week 1" title="Foundations – Python/TypeScript & Git">
                  Get productive with Python or TypeScript, project structure, virtual envs/node tooling, and Git workflows.
                </TimelineItem>
                <TimelineItem week="Week 2" title="Data Handling & APIs">
                  Work with datasets (cleaning, labeling), REST/GraphQL APIs, and basic cloud storage.
                </TimelineItem>
                <TimelineItem week="Week 3" title="ML & LLM Fundamentals">
                  Understand model types, vectorization/embeddings, prompt engineering, and evaluation.
                </TimelineItem>
                <TimelineItem week="Week 4" title="Building AI Features">
                  Integrate LLMs, RAG pipelines, and simple fine-tuning; instrument logging and metrics.
                </TimelineItem>
                <TimelineItem week="Week 5" title="Full‑stack Integration">
                  Build a small feature in a Next.js app, API routes, persistence, and auth basics.
                </TimelineItem>
                <TimelineItem week="Week 6" title="Project & Review">
                  Ship a capstone project, code review, and interview preparation.
                </TimelineItem>
              </div>
              ...
              <div className="mt-10">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>Certificate of completion and portfolio-ready project</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Check className="size-4 text-main mt-0.5 flex-shrink-0" />
                    <span>Eligibility to apply for the AI Developer internship</span>
                  </li>
                </ul>
              </div>
