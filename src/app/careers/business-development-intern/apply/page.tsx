...
export default function ApplyBusinessDevelopmentInternPage() {
  ...
  return (
    <div className="text-foreground font-base px-5 md:py-[80px] py-[60px]">
      <div className="mx-auto w-container max-w-full">
        <h1 className="mb-2">Apply – Business Development Intern</h1>
        <p className="mb-8 text-lg">Apply directly below. No external forms.</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <CardContent>
              {submitted ? (
                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                  ...
                  <Textarea required name="motivation" placeholder="Why are you a good fit for Business Development?" />
                  <Textarea name="experience" placeholder="Relevant experience (sales, partnerships, research)" />
                  ...
                  <div className="flex gap-3">
                    ...
                    <Button variant="neutral" asChild className="rounded-base border-2 border-border px-6 py-2 shadow-shadow hover:translate-x-boxShadowX hover:translate-y-boxShadowY hover:shadow-none">
                      <Link href="/careers#openings">Back to Openings</Link>
                    </Button>
                  </div>
                </form>
              )}
          ...
          <Card className="rounded-base border-2 border-border bg-background shadow-shadow">
            <CardHeader>
              ...
              <CardDescription>Business development internship</CardDescription>
            </CardHeader>
            <CardContent>
              Research markets, support outreach, and assist with building carrier partnerships.
            </CardContent>
          </Card>
        </div>
      </div>
