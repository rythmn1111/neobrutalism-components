...
export default function ApplyDesignInternPage() {
  ...
  return (
    <div className="text-foreground font-base px-5 md:py-[80px] py-[60px]">
      <div className="mx-auto w-container max-w-full">
        <h1 className="mb-2">Apply – Design Intern</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <CardContent>
              {submitted ? (
                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                  ...
                  <Input required name="portfolio" type="url" placeholder="Portfolio / Behance / Dribbble URL" />
                  <Input name="linkedin" type="url" placeholder="LinkedIn URL" />
                  <Textarea required name="motivation" placeholder="Why are you a good fit for Design?" />
                  ...
                  <div className="flex gap-3">
                    ...
                    <Button variant="neutral" asChild className="rounded-base border-2 border-border px-6 py-2 shadow-shadow hover:translate-x-boxShadowX hover:translate-y-boxShadowY hover:shadow-none">
                      <Link href="/careers/design-intern/training">View Training</Link>
                    </Button>
                  </div>
                </form>
              )}
          ...
          <Card className="rounded-base border-2 border-border bg-background shadow-shadow">
            <CardHeader>
              ...
              <CardDescription>Product design internship</CardDescription>
            </CardHeader>
            <CardContent>
              Collaborate with product and engineering to craft intuitive, on‑brand user experiences.
            </CardContent>
          </Card>
        </div>
      </div>
